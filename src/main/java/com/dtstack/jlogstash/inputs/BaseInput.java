...
public abstract class BaseInput implements Cloneable, java.io.Serializable{
    ...
    private static JDisruptor inputToFilterOrOutputDisruptor;
	...
	public IDecode createMultiLineDecoder(Map config){
    	...
    	return new MultilineDecoder(patternStr, what, negate, inputToFilterOrOutputDisruptor);
    }
    ...
    public void process(Map<String,Object> event) {
    	if(event!=null&&event.size()>0){
        	...
        	inputToFilterOrOutputDisruptor.put(event);
    	}
    }
	...
	public static void setInputToFilterDisruptor(JDisruptor inputToFilterOrOutputDisruptor) {
		BaseInput.inputToFilterOrOutputDisruptor = inputToFilterOrOutputDisruptor;
	}

	public static JDisruptor getInputToFilterOrOutputDisruptor() {
		return inputToFilterOrOutputDisruptor;
	}
}
